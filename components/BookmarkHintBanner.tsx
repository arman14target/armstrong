...
export function BookmarkHintBanner() {
  ...
  return (
    <div
      className="fixed-footer pointer-events-none z-40"
      role="status"
      aria-live="polite"
    >
      <div className="pointer-events-auto mx-auto flex max-w-2xl items-center justify-between gap-3 rounded-cyber border border-line/80 bg-panel/95 px-3 py-2 shadow-[var(--shadow-modal)] backdrop-blur-sm sm:px-4">
        ...
        <button
          ...
          className="shrink-0 rounded-cyber border border-cyan/40 px-2.5 py-1 text-[11px] text-cyan transition-colors hover:bg-cyan hover:text-heading sm:text-xs"
        >
          Understood
        </button>
      </div>
